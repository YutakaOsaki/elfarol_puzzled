...
to go
  ...
  if attendance > overcrowding-threshold [
    ...
    set crowded_count crowded_count + 1
    set crowded-sum  crowded-sum + attendance
    set crowded-average crowded-sum / crowded_count
  ]
  if attendance <= overcrowding-threshold [
    set noncrowded_count noncrowded_count + 1
    set noncrowded-sum  noncrowded-sum + attendance
    set noncrowded-average noncrowded-sum / noncrowded_count
  ]

  set possiblity crowded_count / counts
